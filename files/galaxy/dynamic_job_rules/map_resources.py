"""Map jobs to destinations with user input resource allocation."""
...
def dynamic_cores_time(app, tool, job, user_email):
    """Map the job destination based on user estimated CPU and walltime."""
    destination = None
    ...
    try:
        ...
        # WE ARE RESPONSIBLE FOR VALIDATION HERE
